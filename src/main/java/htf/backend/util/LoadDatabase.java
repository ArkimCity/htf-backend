...
//			log.info("Preloading " + meberRepository.save(new Member(1L, "sh", "11", "silver", Timestamp.valueOf(LocalDateTime.now()), new Admin("a2sd","sad",null))));
			...
			log.info("Preloading " + measureRepository.save(new Measure(1L, new Machine("4561a65s1f", new Member(1L, "sh", "11", "enterprise", null,  null, null, null,null, null, new Admin("a2sd","sad",null)), "light1",null, new Vendor("514684", "vpw")), "ligt", "Celcius", Double.valueOf(80), (System.currentTimeMillis()) ,null)));
			log.info("Preloading " + measureRepository.save(new Measure(2L, new Machine("4561a65s1f", new Member(1L, "sh", "11", "enterprise", null,  null, null, null,null, null, new Admin("a2sd","sad",null)), "light1",null, new Vendor("514684", "vpw")), "ligt", "Celcius", Double.valueOf(80), (System.currentTimeMillis()) ,null)));
