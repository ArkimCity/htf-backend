...
//			log.info("Preloading " + meberRepository.save(new Member(1L, "sh", "11", "silver", Timestamp.valueOf(LocalDateTime.now()), new Admin("a2sd","sad",null))));
			...
			log.info("Preloading " + machineRepository.save(new Machine("165165daad", new Member(1L, "om", "11", "silver", null, null, new Admin("asd","sad",null)), "light1",new Vendor("514684", "vpw"))));
			log.info("Preloading " + machineRepository.save(new Machine("5614a65f1f", new Member(1L, "om", "11", "silver", null, null, new Admin("asd","sad",null)), "light2",new Vendor("514684", "vpw"))));
			log.info("Preloading " + machineRepository.save(new Machine("af1a561fas", new Member(1L, "om", "11", "silver", null, null, new Admin("asd","sad",null)), "light3",new Vendor("514684", "vpw"))));
			log.info("Preloading " + machineRepository.save(new Machine("51a65f1afs", new Member(1L, "om", "11", "silver", null, null, new Admin("asd","sad",null)), "light4",new Vendor("514684", "vpw"))));
			log.info("Preloading " + machineRepository.save(new Machine("84a9fasdas", new Member(1L, "om", "11", "silver", null, null, new Admin("asd","sad",null)), "light5",new Vendor("514684", "vpw"))));
			...
			log.info("Preloading " + measureRepository.save(new Measure(1L, new Machine("4561a65s1f", new Member(1L, "sh", "11", "silver", null, null, new Admin("a2sd","sad",null)), "light1",new Vendor("514684", "vpw")), "ligt", "Celcius", "87", String.valueOf(System.currentTimeMillis()-3) ,null)));
